...
import user_defined_view.Vitamio_Mp4_Screen_Double_Press_Big;
 ...
 */
public class Vitamio_Play_Mp4_Activity extends Activity implements View.OnClickListener{

    private static final int SHOW_NETWORK_SPEED = 3;
    public Vitamio_Mp4_Screen_Double_Press_Big mp4VideoView;
    public Uri uri;
    ...
    Handler handler = new Handler(){
        public void handleMessage(Message msg) {
            ...
            if(msg.what==PROGRESS){
                currentPosition = (int) mp4VideoView.getCurrentPosition();
                ...
                String netSpeed = getNetWorkSpeed.showNetSpeed(Vitamio_Play_Mp4_Activity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Vitamio.initialize(Vitamio_Play_Mp4_Activity.this);
        setContentView(R.layout.vitamio_play_mp4_activity);
        popView = LayoutInflater.from(Vitamio_Play_Mp4_Activity.this).inflate(R.layout.mp4_mediacontroller_popupwindow,null);
    ...
    public void initView(){
        ...
        mp4VideoView = (Vitamio_Mp4_Screen_Double_Press_Big) findViewById(R.id.playMp4_videoView);
        ...
        seekBarSound.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(progress>maxVoice*0.6f){
                    Toast.makeText(Vitamio_Play_Mp4_Activity.this,"注意保护听力",Toast.LENGTH_SHORT).show();
                }
    ...
    public void playMp4(){
        ...
        mp4VideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                ...
                int totalTime = (int) mp4VideoView.getDuration();//得到视频总时长
...
//                });
        ...
        mp4VideoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            public boolean onError(MediaPlayer mediaPlayer, int i, int i1) {
                Toast.makeText(Vitamio_Play_Mp4_Activity.this,"亲爱的----视频播放出错",Toast.LENGTH_SHORT).show();
                AlertDialog.Builder dialog = new AlertDialog.Builder(Vitamio_Play_Mp4_Activity.this);
                dialog.setTitle("提示");
                dialog.setMessage("Sorry,视频播放失败");
        ...
        mp4VideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(mp4Position<mp4List.size()-1){
                    Toast.makeText(Vitamio_Play_Mp4_Activity.this,"即将-播发下一首",Toast.LENGTH_SHORT).show();
                    playNextMp4();//如果当期歌曲的下面还有，就自动播发下一个
                }else{//如果是最后一首，播忘就停止
                    Toast.makeText(Vitamio_Play_Mp4_Activity.this,"视频播放完成",Toast.LENGTH_SHORT).show();
                    ...
                    public boolean onInfo(MediaPlayer mediaPlayer, int what, int extra) {
                        switch (what){
                            case MediaPlayer.MEDIA_INFO_BUFFERING_START://视频缓冲开始，即视频开始卡了
                                Toast.makeText(Vitamio_Play_Mp4_Activity.this,"网络不好",Toast.LENGTH_SHORT).show();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN://手指按下
                ...
                startY = event.getY();
                startX = event.getX();
                mp4CurrentPosition = (int) mp4VideoView.getCurrentPosition();
