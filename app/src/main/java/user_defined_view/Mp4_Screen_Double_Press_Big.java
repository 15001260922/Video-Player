 ...
 */
public class Mp4_Screen_Double_Press_Big extends VideoView{
    public Mp4_Screen_Double_Press_Big(Context context) {
        this(context,null);
    }

    public Mp4_Screen_Double_Press_Big(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Mp4_Screen_Double_Press_Big(Context context, AttributeSet attrs, int defStyleAttr) {
